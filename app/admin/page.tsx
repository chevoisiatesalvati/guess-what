      ...
      <div className="max-w-2xl mx-auto">
        <div className="bg-white rounded-2xl shadow-2xl p-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div>
              <label htmlFor="topWord" className="block text-sm font-medium text-gray-700 mb-2">
                Top Word
              </label>
              <input
                type="text"
            ...
            <div>
              <label htmlFor="middleWord" className="block text-sm font-medium text-gray-700 mb-2">
            ...
            <div>
              <label htmlFor="bottomWord" className="block text-sm font-medium text-gray-700 mb-2">
                Bottom Word
              </label>
              <input
                type="text"
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div>
                <label htmlFor="initialPrizePool" className="block text-sm font-medium text-gray-700 mb-2">
            ...
            <div className="bg-blue-50 p-4 rounded-lg">
              <h3 className="font-semibold text-blue-900 mb-2">Game Preview:</h3>
              <div className="text-center space-y-2">
                ...
                <div className="text-xl font-bold text-purple-600 bg-purple-100 py-3 px-4 rounded border-2 border-purple-300">
                  {formData.middleWord ? '•'.repeat(formData.middleWord.length) : '••••••'}
                </div>
                <div className="text-lg font-bold text-gray-900 bg-gray-100 py-2 px-4 rounded">
